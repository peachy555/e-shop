import * as productsReducer from '../../features/product-listing/reducer'
...
describe('todos productsReducer', () => {
  it('should handle LOAD', () => {
    expect(productsReducer.default([], { type: 'LOAD',  payload: testProducts}))
      .toEqual(testProducts)
  })
})